...
MODEL_PATH = "/home/mczhang/zmc-dl/LLM/Meta-Llama-3.1-8B-Instruct"
...
# ======== LoRA 适配器路径 ========
ADAPTER_PATHS = {
    "background_outline": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_outline_back_llama",
    "background_content": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_content_back_llama",
    "problem_outline": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_outline_prob_llama",
    "problem_content": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_content_prob_llama",
    "method_outline": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_outline_method_llama",
    "method_content": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_content_method_llama",
    "contributions_outline": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_outline_cont_llama",
    "contributions_content": "/home/mczhang/zmc-dl/LLM/LLaMA-Factory/lora_results_content_cont_llama",
...
class IntroductionWritingSystem:
    ...
    def _save_outlines(self, outlines: Dict[str, str], paper_id: str):
        """保存大纲"""
        with open(f"writing_agents_results_llama/{self.generate_type}/{paper_id}/introduction_outlines.json", "w", encoding="utf-8") as f:
    ...
    def _save_results(self, results: Dict[str, Any], paper_id: str):
        """保存所有结果"""
        with open(f"writing_agents_results_llama/{self.generate_type}/{paper_id}/introduction_results.json", "w", encoding="utf-8") as f:
...
def main():
    ...
    for item in all_data.keys():
        paper_id = item
        if not os.path.exists(f"writing_agents_results_llama/{args.generate_type}/{paper_id}/introduction_results.json"):
                
            folder_path = f"writing_agents_results_llama/{args.generate_type}/{paper_id}/"
            ...
            # 保存最终结果到文件
            with open(f"writing_agents_results_llama/{args.generate_type}/{paper_id}/introduction.txt", "w", encoding="utf-8") as f:
