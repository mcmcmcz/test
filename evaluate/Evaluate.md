python evaluate_cover_sections.py --generated_type qwen_outline_ta > temp.log 2>&1 &


python evaluate_bleu.py --generated_path ../writing_agents_results_llama/base/
...
python perplexity_similarity.py --generate_type stage_ta